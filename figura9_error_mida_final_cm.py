...
# ----------------------------
# Exemple: generar un CM i cridar les funcions generals
# ----------------------------
def mostra_graus_poisson_trunc(N: int, z: float, kmax: int = 50, seed: int = 0) -> list[int]:
...
def graf_CM_simple(seq_graus: list[int], seed: int = 0, max_tries: int = 200) -> nx.Graph:
    rng = np.random.default_rng(seed)
    millor = None
    millor_arestes = -1
