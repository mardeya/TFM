...
- La carpeta _funcions_ conté el conjunt de funcions generals necessàries per dur a terme les simulacions i la modelització necessària per generar les figures.
