...
# -----------------------------
# Empirical clustering correction
# -----------------------------
def model_ebcm_cluster_corrected_and_align(
    ...
    """
    Correcció fenomenològica de l'EBCM per xarxes amb clustering elevat.

    Idea:
      tau_eff = tau * (1 - alpha * C)
      t_corr  = t * stretch, amb stretch = 1 / (1 - beta * C)

    on C és una mesura del clustering de la xarxa.
    """
...
# -----------------------------
# Plot 1x3 figure for fixed k and 3 p values
# -----------------------------
def plot_ws_fixed_k_three_p(
    ...
    Each subplot:
      simulations + EBCM + EBCM pref-mix + optional corrected EBCM
    """
    ...
    for j, p in enumerate(p_values):
        ...
        sim_curves = run_simulations_WS(
            ...
            n_sims=n_sims, initial_I=initial_I,
            Ith=Ith, tmax=tmax,
...
if __name__ == "__main__":
    ...
    # Pots tocar aquests dos paràmetres per millorar l'ajust
    alpha = 1.0
    beta = 1.0
